//
//  TransaksiDetail.swift
//  MahkotaMotor
//
//  Created by Athanasius Aryatyasto Pranamya on 29/07/20.
...
class TransaksiDetail: UIViewController {
                ...
                if let transaksi = querySnapshot?.documents {
                    if transaksi.isEmpty {
                        ...
                        for i in 0..<self.transaksiList.count {
                            if AddTransaksi.temp_id == self.transaksiList[i].transaksi_id  {
